          ...
          <div className="w-2/5 flex flex-col justify-center items-end pl-0 pr-20">
            ...
            <div className="contents tracking-wide text-right text-greytext">
              ...
              <p
                ...
                ref={(el) => (props.performanceAnim.current[0] = el)}
              >
                Top Speed of <span className="font-medium">135</span> kmph
              </p>
              <h3
                className="text-white text-lg"
              ...
              <p
                className="text-3xl font-light mb-8"
                ref={(el) => (props.performanceAnim.current[1] = el)}
              >
                <span className="font-medium">150</span> km Real World Range
              </p>
              <h3
                className="text-white text-lg"
                ref={(el) => (props.titlesAnim.current[6] = el)}
              >
                First off the traffic line.
              </h3>
              <p
                className="text-3xl font-light mb-8"
                ref={(el) => (props.performanceAnim.current[2] = el)}
              >
                0-60 kmph in &#60; <span className="font-medium">3.5</span> secs
                <span className="text-2xl">*</span>
              </p>
              <h3
                className="text-white text-lg"
                ref={(el) => (props.titlesAnim.current[7] = el)}
              >
                Get to your destination quicker.
              </h3>
              <p
                className="text-3xl font-light mb-8"
                ref={(el) => (props.performanceAnim.current[3] = el)}
              >
                0-80% charge in <span className="font-medium">45</span> mins
                <span className="text-2xl">*</span>
              </p>
            </div>
          </div>
        ...
        <div className="relative">
          <div className="flex flex-col h-full">
            <div className="mt-8 flex flex-col justify-start items-end pr-4">
              ...
              <div className="contents tracking-wide text-right text-greytext">
                <h3 className="text-white text-lg">Electric is now fast.</h3>
                <p className="text-2xl font-light mb-3">
                  Top Speed of 135 kmph
                </p>
                <h3 className="text-white text-lg">Week long charge.</h3>
                <p className="text-2xl font-light mb-3">
                ...
                <p className="text-2xl font-light mb-3">
                  0-60 kmph in &#60; 3.5 secs<span className="text-xl">*</span>
                </p>
                <h3 className="text-white text-lg">
                  Get to your destination quicker.
                </h3>
                <p className="text-2xl font-light mb-3">
                  0-80% charge in 45 mins<span className="text-xl">*</span>
                </p>
              </div>
            </div>
