...
function ZeroSection(props) {
  return (
    <div>
      ...
      <section
        className="bg-black h-180vh relative sm:hidden"
        id="zero-id"
        ref={props.zeroSection}
      >
        <div className="h-full flex">
          {/* titles and contents */}
          <section className="h-screen w-2/6 bg-black sticky top-0">
            <div
              className="title mt-32 h-28 pl-20"
            ...
            >
              ...
              <div className="h-12 overflow-hidden">
                <span
                  className="block h-full font-oswald ease-in duration-500 font-light text-4xl tracking-wide"
                  ref={props.zeroWord1}
                >
                  Hassle
                </span>
            ...
            {/* CONTENTS */}
            <div
              className="h-80 w-96 mt-10 pl-20 overflow-hidden text-2xl"
      ...
      <section className="bg-black h-180vh hidden sm:block">
        <div className="h-full flex">
          ...
          <section className="h-screen bg-black sticky top-0">
            <div className="h-40vh">
              <div className="title mt-10 h-28 pl-4">
                ...
                <div className="h-10 overflow-hidden">
                  <span
                    className="block h-full font-oswald ease-in duration-500 font-light text-3xl tracking-wide"
                    ref={props.MzeroWord1}
                  >
                    Hassle
                  </span>
                  <span
                    className="block h-full font-oswald ease-in duration-500 font-light text-3xl tracking-wide"
                    ref={props.MzeroWord2}
                  >
                    Emissions
                  </span>
                  <span
                    className="block h-full font-oswald ease-in duration-500 font-light text-3xl tracking-wide"
                    ref={props.MzeroWord3}
                  >
                    Maintenance
                  </span>
                </div>
              ...
              <div className="h-60 w-5/6 pl-4 overflow-hidden">
                <span
                  className="block h-full ease-in duration-500 text-lg tracking-wide text-greytext "
                  ref={props.MzeroCont1}
                >
                  <h3>
                    Breakdowns, failures, and repairs are all things of the
                    past. We promise not only a futuristic motorcycle, but also
                    a futuristic and hassle-free riding experience.
                  </h3>
                </span>
                <span
                  className="block h-full ease-in duration-500 text-lg tracking-wide text-greytext"
                ...
                >
                  <h3>
                    ...
                    Electric is the future, and we&#39;re building for it right
                    now.
                  </h3>
                </span>
                <span
            ...
            {/* Image section */}
            <section
              className="h-60vh sticky top-0
                bg-zerobg1 bg-cover bg-no-repeat bg-center ease-in duration-500"
              ref={props.MzeroImg}
            ></section>
          </section>
        </div>
