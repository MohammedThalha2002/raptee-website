...
function TechHome(props) {
    return (
        <div>
            <section className='bg-black aspect-16/8 relative sm:hidden' id='techHome-id' ref={props.productsSection}>
                    ...
                    <div className="absolute left-0 top-20 pl-20 pt-6 ">
                        <div className="content text-left">
                            <h3 className='text-4xl font-light font-oswald 
                                    tracking-widest mb-4' ref={(el) => (props.titlesAnim.current[0] = el)}>
                                Technology engineered beyond boundaries.
                            </h3>
                            <h4 className='text-2xl font-thin tracking-widest w-2/3' ref={(el) => (props.parasAnim.current[0] = el)}>
