...
function Techstory() {
  ...
  useEffect(() => {
    ...
    const techSectionObserver = new IntersectionObserver(
      observerCallback,
      observerOptions
    );
  ...
  return (
    <div className="bg-black">
      ...
      <div>
        ...
        {/*  */}
        <VcuSection
          vcuSection={vcuSection}
          titlesAnim={titlesAnim}
          parasAnim={parasAnim}
        ></VcuSection>
        {/*  */}
        <BmsSection
          bmsSection={bmsSection}
          titlesAnim={titlesAnim}
          parasAnim={parasAnim}
        ></BmsSection>
        {/* */}
