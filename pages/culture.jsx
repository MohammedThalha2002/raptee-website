    ...
    <div className="w-full">
      ...
      <div className="w-full">
        <section className="bg-black relative">
          <div
            className="aspect-video bg-culturebg bg-cover bg-center"
            aria-label="People of Raptee Community - A culture that is much more than just work"
          ></div>
          <div className="absolute z-10 top-96 pl-1/10 w-3/4 sm:top-60">
            ...
            >
              <h2 className="text-2xl sm:text-lg font-oswald tracking-wide">
                The
              </h2>
            ...
            <div className="w-4/5">
              <Image
                ...
                width={16}
                priority={true}
                alt="Raptee employees playing - Saturday's foosball tournament"
              />
            </div>
            <div className="absolute w-1/30 top-30rem sm:top-60 left-1/80 sm:left-1/90">
              <Image
                ...
                height={16}
                priority={true}
                alt="People of Raptee Community - A culture that is much more than just work"
              />
            </div>
            ...
            <div className="w-2/3 sm:w-4/5 mt-16 pl-1/5">
              <div className="text-left flex flex-col items-start">
                ...
                <div className="underline w-14 h-0.5 rounded-xl my-2 mx-1 bg-highlight"></div>
                <p className="text-2xl sm:text-sm tracking-wide text-gray-500">
              ...
              {caurosel.map((items) => (
                <div key={items.id}>
                  <Image
                    ...
                    height={240}
                    width={160}
                    alt="Raptee team - strives at the brink of innovation"
                  />
                </div>
              ))}
            </div>
        ...
        <section className="bg-black relative">
          ...
          <div className="relative mx-12 sm:mx-4 flex items-end">
            <div className="w-1/35 ease-in duration-200 hover:scale-110">
              <Image
                ...
                height={1080}
                width={1920}
                alt="Keerthivasan, CTO & Co-founder at Raptee"
              />
            </div>
            <div className="w-1/20 h-40 sm:h-12 bg-greydiv flex flex-col justify-end p-2 sm:p-1 ease-in duration-200 hover:scale-110">
              ...
              <h3 className="text-2xl sm:text-mmb sm:leading-normal font-bold text-white">
                CONFIDENT
              </h3>
            </div>
          ...
          <div className="relative mx-12 sm:mx-4 flex ">
            ...
            <div className="w-1/15 h-28 sm:h-10 bg-highlight flex flex-col justify-end p-2 sm:pl-1 ease-in duration-200 hover:scale-110">
              ...
              <h3 className="text-2xl sm:text-mmb sm:leading-normal font-bold sm:font-semibold text-white">
                BRAVE
              </h3>
            </div>
            <div className="w-1/45 ease-in duration-200 hover:scale-110">
              <Image
                ...
                height={1080}
                width={1920}
                alt="Team Raptee with Dinesh Arjun, CEO at Raptee"
              />
            </div>
            <div className="w-1/25 aspect-video flex items-end">
              <div className="w-full h-40 sm:h-12 bg-highlight flex flex-col justify-end p-2 sm:pl-1 ease-in duration-200 hover:scale-110">
                ...
                <h3 className="text-2xl sm:text-mmr sm:leading-normal font-bold sm:font-semibold text-white">
                  UNCOMPROMISING
                </h3>
              </div>
            </div>
