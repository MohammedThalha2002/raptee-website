  ...
  return (
    <section className="bg-black w-full h-full p-4 flex flex-col items-center">
      ...
      <div className="w-4/5 text-center border-2 border-white p-4 my-8 rounded-lg">
        <h1 className="font-medium font-oswald text-3xl my-8">OVERVIEW</h1>
        <h3 className="text-xl">
          This website is operated by Raptee Energy Pvt. Ltd.. Throughout the
          site, the terms “we”, “us” and “our” refer to Raptee Energy Pvt. Ltd..
          Raptee Energy Pvt. Ltd. offers this website, including all
      ...
      <div className="w-4/5 text-center border-2 border-white p-4 my-8 rounded-lg">
        <h1 className="font-medium font-oswald text-3xl my-8">
          ACCURACY OF BILLING AND ACCOUNT INFORMATIONAGE OF CONSENT
        </h1>
        <h3 className="text-xl">
